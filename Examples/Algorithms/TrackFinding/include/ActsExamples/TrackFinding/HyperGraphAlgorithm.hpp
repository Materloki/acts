...
class HyperGraphAlgorithm final: public IAlgorithm {
  public:
    ...
    using TrackFinderOptions = 
        Acts::MultiTrackFinderOptions<TrackContainer>;
    using TrackFinderResult = 
        Acts::Result<std::vector<TrackContainer::TrackProxy>>;

    /// Find function that takes the above parameters
    /// @note This is separated into a virtal interface to keep compilation units
    /// small
  ...
  struct Config {
    ...
    /// MTF measurement selector config
  ...
  /// Constructor of the hypegraph algorithm
  ///
  ...
  /// Framework execute method of the hypegraph algorithm
  ///
