...
if args.reco:
    ...
    HyperGraphAlgorithm = acts.examples.HyperGraphAlgorithm(level = acts.logging.INFO,
    ...
    **acts.examples.defaultKWArgs(
    ...
    s.addAlgorithm(HyperGraphAlgorithm)
    s.addWhiteboardAlias("tracks", HyperGraphAlgorithm.config.outputTracks)
